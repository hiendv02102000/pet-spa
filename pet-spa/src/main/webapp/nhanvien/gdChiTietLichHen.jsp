...
<html lang="en">
    ...
    <%
        ...
        //   return;
        // }
        int lhid = Integer.parseInt(request.getParameter("id_lh"));
    ...
    <body>
        <header>
            <div class="nav1">
                <div class="logo">
                    <a href="gdKTLichHen.jsp"><img src="../assets/img/logo.png" alt="logo" class="place-img"> </a>
                </div>
            </div>
        </header>
            ...
            <tr>
                ...
                <%
                    ...
                    for (int i = 0; i < list.length; i++) {
                        ...
                        tong = tong.add(t);
                        String tien = FormateDateTime.convertBigNumToCurrency(list[i].getDichVu().getGiaCa());
                %>
            <tr class="table__row">
